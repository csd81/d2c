...
def getSystemPrompt() -> str:
    ...
    return (
        ...
        "## Context economy\n"
        "- Inspect before dumping: prefer Grep, Glob, ListDir, FileInfo, CodeSymbols, "
        "GitDiff, GitStatus to locate what you need.\n"
        "- Use ReadRange when you know the line range; use full Read only when the "
