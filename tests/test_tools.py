...
async def test_assemble_tool_pool():
    ...
    names = {t.name for t in tools}
    assert names == {"Read", "Write", "Edit", "Bash", "Agent", "Skill", "WebFetch", "WebSearch", "Glob", "Grep", "NotebookEdit", "TaskCreate", "TaskUpdate", "TaskList", "ToolSearch", "AgentStatus", "Remember"}
